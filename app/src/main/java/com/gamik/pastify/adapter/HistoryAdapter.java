    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    StandOutWindow.close(context, OverLayListActivity.class, StandOutWindow.DEFAULT_ID);
                    ClipboardManager clipboard = (ClipboardManager) context.getSystemService(Context.CLIPBOARD_SERVICE);
                    ClipData clip = ClipData.newPlainText("paster", value);
                    clipboard.setPrimaryClip(clip);
                    store.updateDataByPlaceHolder((String) placeHolder.getText(), "Usage", ++usage);
                    //StandOutWindow.hide(context,OverLayListActivity.class,StandOutWindow.DEFAULT_ID);
                    Intent intent = new Intent("smart");
                    intent.putExtra("smartmode", true);
