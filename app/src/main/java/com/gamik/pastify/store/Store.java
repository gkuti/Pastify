...
public class Store extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        sqLiteDatabase.execSQL("CREATE TABLE " + "DATA" + "(" + "_id" + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
                "PlaceHolder" + " VARCHAR, " + "Value" + " VARCHAR, " + "Date" + " VARCHAR, " + "Status" + " INTEGER, " + "Usage" + " INTEGER);");
    }
    ...
    public long saveData(String placeHolder, String value, String date, int status, int usage) {
        SQLiteDatabase sqLiteDatabase = this.getWritableDatabase();
        ContentValues cv = new ContentValues();
        cv.put("PlaceHolder", placeHolder);
        cv.put("Value", value);
        ...
        long code = sqLiteDatabase.insert("DATA", null, cv);
        sqLiteDatabase.close();
        return code;
    }
    ...
    public long updateDataByPlaceHolder(String placeHolder, String column, int value) {
        SQLiteDatabase sqLiteDatabase = this.getWritableDatabase();
        ContentValues cv = new ContentValues();
